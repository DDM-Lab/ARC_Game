...
{
    public class MovementTesting : TestingBase
    {
        public override string ScenePath => @"Assets/SoftLeitner/CityBuilderCore.Tests/City/Movements/MovementDebugging.unity";
