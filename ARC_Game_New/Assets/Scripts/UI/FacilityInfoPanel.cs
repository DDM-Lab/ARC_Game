...
public class FacilityInfoPanel : MonoBehaviour
{
    ...
    void CreateTaskListItem(GameTask task)
    {
        ...
        TextMeshProUGUI taskType = item.transform.Find("TaskType")?.GetComponent<TextMeshProUGUI>();
        TextMeshProUGUI taskRounds = item.transform.Find("TaskRounds")?.GetComponent<TextMeshProUGUI>();
