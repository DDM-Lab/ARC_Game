...
# staff_<seed>.json/.log oracle corpus (test_lockstep ratchet). CORA_SIM_VALIDATE points the tools at
# another capture set, e.g. one driven through a different Unity build (runs/validate_v1).
VALIDATE = os.environ.get("CORA_SIM_VALIDATE") or os.path.join(RUNS, "validate")
