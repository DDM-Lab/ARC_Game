...
{
    /// <summary>
    /// scriptable that can be uniquely identified by a string key<br/>
    /// it can then be retrieved from <see cref="KeyedSet{T}"/> by its key
    /// </summary>
    /// <remarks><see href="https://citybuilder.softleitner.com/manual">https://citybuilder.softleitner.com/manual</see></remarks>
    [HelpURL("https://citybuilderapi.softleitner.com/class_city_builder_core_1_1_keyed_object.html")]
    public class KeyedObject : ScriptableObject, IKeyed
    {
        ...
        public static T GetKeyedObject<T>(string key) => IKeyedSet<T>.GetKeyedObject(key);
    }
}